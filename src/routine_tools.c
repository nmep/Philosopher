...
// /*   Updated: 2024/03/26 19:43:40 by lgarfi           ###   ########.fr       */
// /*                                                                            */
// /* ************************************************************************** */
...
// // du thread actuel
// inline void	ft_init_fork_data(t_philo *philo, t_fork_data *fork_pose)
// {
...
// {
// 	printf("lf state %d | rf state %d\n", fork_pose->l_fork.state, fork_pose->r_fork.state);
...
// inline	void ft_eat(t_philo *philo, pthread_mutex_t first_lock, pthread_mutex_t second_lock, t_fork_pos *current_pose)
// {
// 	gettimeofday(&philo->timestamp, NULL);
...
// 	pthread_mutex_lock(&philo->print);
// 	printf("%ld philo %d has eaten\n", philo->timestamp.tv_usec, current_pose->l_fork.fork_number);
// 	pthread_mutex_unlock(&philo->print);
